...
export default function StarRating({
  ...
  const showedRating = tmpRating || rating;
  const viewRatingMessage = messages.length === maxRating ? messages[showedRating - 1] : showedRating;
  ...
  return <div style={containerStyle} className={className}>
    ...
    <p style={textStyle}>{viewRatingMessage || ""}</p>
  </div>
}
